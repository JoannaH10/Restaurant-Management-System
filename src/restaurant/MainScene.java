...
public class MainScene extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button loginButton = new Button("Login");  // Create a Login button
        ...
        Button signInButton = new Button("Sign In");  // Create a Sign In button
        ...
        Label guestLabel = new Label("Are you a guest? Sign in.");  // Display a message for guests
